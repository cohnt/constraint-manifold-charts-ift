...
// NOTICE: This file has been modified from the OpenRAVE original. The change is
// the addition of the `#include "Python.h"` block marked //// START ... //// END
// below, required by the CPython extension entry points in the generated
// rainbow_{left,right}_arm_ik.cpp. No other change has been made.
